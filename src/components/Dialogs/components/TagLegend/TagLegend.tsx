...
const TagLegend = () => {
  return (
    <Styled.TagLegendContainer>
      ...
      added. */}
      Tags colored with grey means that some of the selected photos contains
      that tag. If tag is orange, all selected photos contains that tag. Blue
      tags are the tags you just added.
    </Styled.TagLegendContainer>
  );
};
